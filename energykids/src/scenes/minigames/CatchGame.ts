...
export class CatchGame extends Phaser.Scene {
    ...
    addPlayers() {
        ...
        this.paddleOne.__proto__ = this.add.rectangle(wha - 200, oy, size, size, 0x0000ff, 0x555555);
        ...
        this.paddleTwo.__proto__ = this.add.rectangle(wha + 200, oy, size, size, 0x0000ff, 0x555555);
    }
